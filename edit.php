    ...
    <form action="edit.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Article" name="article"
          value="<?php echo $part->article; ?>">
      </div>

      <div class="form-group">
        <label>Part Name</label>
        <input type="text" class="form-control" placeholder="Part Name" name="part_name"
          value="<?php echo htmlspecialchars($part->name, ENT_QUOTES, 'UTF-8'); ?>">
      </div>

      <div class="form-group">
        <label>Quantity</label>
        <input type="number" class="form-control" placeholder="Quantity" name="quantity"
          value="<?php echo $part->quantity; ?>" step="0.01">
      </div>

      <div class="form-group">
        <label>Price</label>
        <input type="number" step="0.001" class="form-control" placeholder="Price" name="price"
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" placeholder="Description"
          name="description"><?php echo $part->description; ?></textarea>
      </div>

      <div class="form-group">
        <label>Barcode</label>
        <input type="text" class="form-control" placeholder="Barcode" name="barcode"
          value="<?php echo $part->barcode; ?>">
      </div>
